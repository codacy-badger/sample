...
// update post page
$I->amOnPage('/post/update/seeker/11?redirect_uri=%2Fprofile%2Fpost%2Fsearch');
$I->seeInCurrentUrl('/post/update/seeker/11?redirect_uri=%2Fprofile%2Fpost%2Fsearch');
...
// fill edit fields
$I->fillField('.page-post-update form#post-form input[name="post_name"]', 'Foo barss');
$I->fillField('.page-post-update form#post-form input[name="post_position"]', '');
$I->fillField('.page-post-update form#post-form input[name="post_location"]', 'Quezon City');
...
$I->fillField('.page-post-update form#post-form input[name="post_position"]', 'Programmer');
$I->fillField('.page-post-update form#post-form input[name="post_location"]', 'Quezon City');
$I->fillField('.page-post-update form#post-form input[name="post_email"]', 'test@test');
...
$I->fillField('.page-post-update form#post-form input[name="post_position"]', 'Programmer');
$I->fillField('.page-post-update form#post-form input[name="post_location"]', 'Quezon City');
$I->fillField('.page-post-update form#post-form input[name="post_email"]', 'test@test.com');
...
$I->fillField('.page-post-update form#post-form input[name="post_location"]', 'Quezon City');
$I->fillField('.page-post-update form#post-form input[name="post_email"]', 'test@test.com');
$I->fillField('.page-post-update form#post-form input[name="post_phone"]', '4445');
