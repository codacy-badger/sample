...
class Validator
{
    ...
    {
        //validations
        if (isset($data['event_start']) && isset($data['event_end']) &&
        strtotime($data['event_end']) <= strtotime($data['event_start'])) {
            $errors['event_end'] = 'Invalid event end date';
        }
