...
CREATE TABLE `applicant` (`applicant_id` int(10) UNSIGNED NOT NULL auto_increment, `applicant_active` int(1) UNSIGNED NOT NULL DEFAULT 1, `applicant_created` datetime NOT NULL, `applicant_updated` datetime NOT NULL, `applicant_status` json DEFAULT NULL, `applicant_type` varchar(255) DEFAULT NULL, `applicant_flag` int(1) unsigned DEFAULT 0, PRIMARY KEY (`applicant_id`), KEY `applicant_active` (`applicant_active`), 
...
CREATE TABLE `applicant_post` (`applicant_id` int(10) UNSIGNED NOT NULL, `post_id` int(10) UNSIGNED NOT NULL, PRIMARY KEY (`applicant_id`, `post_id`));
...
CREATE TABLE `label` (`label_id` int(10) UNSIGNED NOT NULL auto_increment, `label_active` int(1) UNSIGNED NOT NULL DEFAULT 1, `label_created` datetime NOT NULL, `label_updated` datetime NOT NULL, `label_custom` json DEFAULT NULL, `label_type` varchar(255) DEFAULT NULL, `label_flag` int(1) unsigned DEFAULT 0, PRIMARY KEY (`label_id`), KEY `label_active` (`label_active`), 
