 ...
 */
class Cradle_Module_Tracking_Applicant_Service_ElasticServiceTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    /**
     * @covers Cradle\Module\Tracking\Applicant\Service\ElasticService::__construct
     */
    ...
    public function testRemove()
    {
        ...
        $this->assertEquals('applicant', $actual['_index']);
