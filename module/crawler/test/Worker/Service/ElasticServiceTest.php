 ...
 */
class Cradle_Module_Crawler_Worker_Service_ElasticServiceTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    /**
     * @covers Cradle\Module\Crawler\Worker\Service\ElasticService::__construct
     */
    ...
    public function testRemove()
    {
        ...
        $this->assertEquals('worker', $actual['_index']);
