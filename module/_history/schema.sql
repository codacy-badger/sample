...
DROP TABLE IF EXISTS `history_thread`;

CREATE TABLE `history_thread` (`history_id` int(10) UNSIGNED NOT NULL, `thread_id` int(10) UNSIGNED NOT NULL, PRIMARY KEY (`history_id`, `thread_id`));
