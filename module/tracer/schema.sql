...
DROP TABLE IF EXISTS `information_downloaded`;

CREATE TABLE `information_downloaded` (`information_id` int(10) UNSIGNED NOT NULL, `profile_id` int(10) UNSIGNED NOT NULL, PRIMARY KEY (`information_id`, `profile_id`));

ALTER TABLE `information` ADD `information_download_count` INT(10) NOT NULL DEFAULT '0' AFTER `information_skills`;
