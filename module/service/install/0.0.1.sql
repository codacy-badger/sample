...
CREATE TABLE `service` (`service_id` int(10) UNSIGNED NOT NULL auto_increment, `service_active` int(1) UNSIGNED NOT NULL DEFAULT 1, `service_created` datetime NOT NULL, `service_updated` datetime NOT NULL, `service_name` varchar(255) DEFAULT NULL, `service_credits` int NOT NULL, `service_type` varchar(255) DEFAULT NULL, `service_flag` int(1) unsigned DEFAULT 0, PRIMARY KEY (`service_id`), KEY `service_active` (`service_active`), 
