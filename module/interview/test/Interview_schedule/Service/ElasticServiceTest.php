 ...
 */
class Cradle_Module_Interview_Interview_schedule_Service_ElasticServiceTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    /**
     * @covers Cradle\Module\Interview\Interview_schedule\Service\ElasticService::__construct
     */
    ...
    public function testRemove()
    {
        ...
        $this->assertEquals('interview_schedule', $actual['_index']);
