 ...
 */
class Cradle_Module_Interview_Interview_setting_Service_ElasticServiceTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    /**
     * @covers Cradle\Module\Interview\Interview_setting\Service\ElasticService::__construct
     */
    ...
    public function testRemove()
    {
        ...
        $this->assertEquals('interview_setting', $actual['_index']);
    ...
    public function testGet()
    {
        ...
        $this->assertEquals(1, $actual['interview_setting_id']);
    }
    ...
    public function testSearch()
    {
        ...
        $this->assertEquals(1, $actual['rows'][0]['interview_setting_id']);
    }
