...
CREATE TABLE `blog` (`blog_id` int(10) UNSIGNED NOT NULL auto_increment, `blog_active` int(1) UNSIGNED NOT NULL DEFAULT 1, `blog_created` datetime NOT NULL, `blog_updated` datetime NOT NULL, `blog_title` varchar(255) DEFAULT NULL, `blog_image` varchar(255) DEFAULT NULL, `blog_slug` varchar(255) DEFAULT NULL, `blog_article` text(1000) DEFAULT NULL, `blog_description` varchar(255) DEFAULT NULL, `blog_keywords` json DEFAULT NULL, `blog_view_count` int DEFAULT NULL, `blog_facebook_title` varchar(255) DEFAULT NULL, `blog_facebook_image` varchar(255) DEFAULT NULL, `blog_facebook_description` varchar(255) DEFAULT NULL, `blog_twitter_title` varchar(255) DEFAULT NULL, `blog_twitter_image` varchar(255) DEFAULT NULL, `blog_twitter_description` varchar(255) DEFAULT NULL, PRIMARY KEY (`blog_id`), KEY `blog_active` (`blog_active`), 
