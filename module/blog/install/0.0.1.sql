...
CREATE TABLE `blog` (`blog_id` int(10) UNSIGNED NOT NULL auto_increment, `blog_active` int(1) UNSIGNED NOT NULL DEFAULT 1, `blog_created` datetime NOT NULL, `blog_updated` datetime NOT NULL, `blog_title` varchar(255) DEFAULT NULL, `blog_image` varchar(255) DEFAULT NULL, `blog_slug` varchar(255) DEFAULT NULL, `blog_article` text DEFAULT NULL, `blog_description` varchar(255) DEFAULT NULL, `blog_keywords` json DEFAULT NULL, `blog_facebook_title` varchar(255) DEFAULT NULL, `blog_facebook_slug` varchar(255) DEFAULT NULL, `blog_facebook_image` varchar(255) DEFAULT NULL, `blog_facebook_description` varchar(255) DEFAULT NULL, `blog_twitter_title` varchar(255) DEFAULT NULL, `blog_twitter_slug` varchar(255) DEFAULT NULL, `blog_twitter_image` varchar(255) DEFAULT NULL, `blog_twitter_description` varchar(255) DEFAULT NULL, PRIMARY KEY (`blog_id`), KEY `blog_active` (`blog_active`), 
KEY `blog_created` (`blog_created`), 
KEY `blog_updated` (`blog_updated`), 
KEY `blog_title` (`blog_title`), 
KEY `blog_image` (`blog_image`), 
KEY `blog_slug` (`blog_slug`), 
KEY `blog_article` (`blog_article`), 
KEY `blog_description` (`blog_description`), 
KEY `blog_facebook_title` (`blog_facebook_title`), 
KEY `blog_facebook_slug` (`blog_facebook_slug`), 
...
KEY `blog_twitter_slug` (`blog_twitter_slug`), 
